...
| Research working files | `reference/evaluation-graph/` (see its [README](../../reference/evaluation-graph/README.md)): `lazebny-and-forums.md` (1592 lines: verbatim quotes + translations + 8 DXF dumps + a 21-row source table), `raw/` (90+ official API pages), `dwg_full_thread.txt` (all 717 forum posts), Lazebny parts 7–12 (EN + RU) | the raw material behind the findings above, **committed for re-verification** | kept |
