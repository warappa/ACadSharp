...
public class BlockPolarStretchAction : StretchActionBase, IDxfClassDefined
{
	/// <inheritdoc/>
	[DxfCodeValue(140)]
	...
	/// a computed read of it). For a polar stretch action this is the full (X, Y) displacement.
	/// </summary>
	...
	public DxfClass GetDxfClass()
	{
		return new DxfClass
		{
			CppClassName = DxfSubclassMarker.BlockPolarStretchAction,
